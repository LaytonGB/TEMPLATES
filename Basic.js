var APIName = APIName || (function () {
    var stateName = 'APIName',
        states = [
            ['Name', ['acceptable', 'Values'], 'defaultValue']
        ],
        name = 'API Name',
        ...
        showHelp = function () {
            let commandsArr = [
                [
                    '!command',
                    'What it does.',
                    `${code('!parameter1')} ${code('parameter2')}`,
                    ['parameter1', 'How to use it.']
                ]
            ];
        ...
        handleInput = function (msg) {
            ...
            if (msg.type === 'api' && msg.content.split(' ')[0] === '!api') {
